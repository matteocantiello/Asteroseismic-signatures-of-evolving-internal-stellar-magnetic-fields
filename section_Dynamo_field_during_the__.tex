...
Efficient dynamo action is expected for fast rotation, i.e. $Ro<1$. In this case the field is expected to be large scale and with an amplitude corresponding to equipartition between the magnetic energy ($B^2/8\pi$) and the kinetic energy in the flow ($1/2\rho v^2_{\rm conv}$, referred as ``equipartition'' field).
