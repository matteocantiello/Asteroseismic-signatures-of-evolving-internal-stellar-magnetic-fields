...
\end{equation}
Here, $v_{\rm con}$ is the convective velocity according to MLT, $v_{\rm con} \approx (F/\rho)^{1/3}$, and $F$ is the energy flux carried by convection. We find typical field strengths of $B \sim 2 \times 10^5 \, {\rm G}$ on the MS and assume they are confined to the maximal extent of the core convective region. We then assume that magnetic flux is conserved as the star evolves into a red giant, such that
\begin{equation}
\label{eqn:Brgb}
