...
\end{equation}
evaluated at angular wave frequencies $\omega = 2 \pi \nu_{\rm max}$. Figure \ref{fig:BcClump} shows the minimum field strength required for mode suppression, $B_{c,{\rm min}}$, evaluated at the peak in $N$ at the H-burning shell, for stars on the red clump. In general, fields of $10^4-10^5 \, {\rm G}$ are sufficient for mode suppression. 
