...
\end{equation}
Figure \ref{fig:DipoleHist} plots $B_{\rm cen}$ in our stellar models. Central magnetic fields of $B_{\rm cen} \sim 10^5 \, {\rm G}$ are expected during the MS, while field strengths of $B_{\rm cen} \sim 10^7 \, {\rm G}$ are expected on the clump if the fields survive to this phase of evolution. In general, field strengths of $B_{\rm RG} > 10^6 \, {\rm G}$ can be expected near the centers of red giant stars.
