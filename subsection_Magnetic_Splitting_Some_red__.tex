...
\end{equation}
Here, $\Delta \nu_{\rm g}$ is the g mode frequency spacing between mixed modes, $B_r$ is the radial component of the field, and $B_c$ is the critical field strength (equation \ref{eqn:Bc}). 
