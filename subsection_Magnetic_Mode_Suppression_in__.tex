...
Again we assumed that the field has been created by an equipartition convective core dynamo during the main sequence (eq.~\ref{eqn:Beq}). We then estimate core magnetic fields in clump stars assuming magnetic flux conservation (eq.~\ref{eqn:Brgb}). As shown in the bottom panel of Figures \ref{fig:ClumpProp} and \ref{fig:ClumpPropMassive}, magnetic fields of $B_{\rm RG} > 10^6 \, {\rm G}$ may exist in the cores of clump stars. 
